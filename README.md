# Dena
A growing collection of reusable Anthropic Skills I use across Claude Code, Claude Desktop, and Claude.ai. Each skill captures a workflow I run repeatedly so I don't reinvent it every time.  Maintained by @Arpit (founder, Accelerate AI).
Skills in this repo
Skill	What it does	When to use it
market-gap-research	Mines X, Reddit, and review sites via Apify to surface product gaps and unmet feature requests, then ships an Instagram carousel / LinkedIn post / research report.	Competitor research, finding SaaS wedges, complaint mining, "what do users wish X did?"
...
If you fork, swap out the voice/aesthetic notes in each skill (mine are tuned for @Arpit and @Arpitkumar).
